...
import { Wallet, Building2, TrendingUp, DollarSign, ArrowUpRight } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Card className="p-8 bg-gradient-card border-border relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-5xl font-bold font-mono terminal-glow mb-6">$12,450.00</p>
          <div className="flex gap-3">
            <div className="flex-1 bg-muted/20 rounded-lg p-3">
              <p className="text-xs text-muted-foreground">Available</p>
              <p className="text-lg font-mono font-semibold">$12,450.00</p>
            </div>
            <div className="flex-1 bg-muted/20 rounded-lg p-3">
              <p className="text-xs text-muted-foreground">Staked</p>
              <p className="text-lg font-mono font-semibold text-accent">$0.00</p>
            </div>
          </div>
        </div>
      </Card>
